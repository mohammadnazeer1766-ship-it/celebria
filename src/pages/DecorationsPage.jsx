...
const DecorationsPage = () => {
    return (
        <div className="relative min-h-screen pb-20 pt-12 transition-colors duration-300 overflow-hidden">
            <FunkyBackground />
            <div className="container mx-auto px-4 py-8 relative z-10">
                <h1 className="text-2xl md:text-3xl font-black text-center text-gray-900 dark:text-white mb-12 drop-shadow-md">
