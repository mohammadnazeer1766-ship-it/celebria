...
const ads = [
    {
        ...
        image: "https://img.favpng.com/20/19/8/birthday-background-colorful-party-decorations-with-bunting-and-confetti-zKkhBVdr.jpg",
...
const PromoBanner = () => {
    ...
    return (
        <div className="relative w-full overflow-hidden bg-white dark:bg-gray-900 h-[300px] md:h-[400px]">
            {/* Ad Slides */}
            {ads.map((ad, index) => (
                <div
                    key={ad.id}
                ...
                >
                    ...
                    {/* Content */}
                    <div className="relative h-full flex items-center container mx-auto px-4 md:px-12">
                        <div className="max-w-2xl animate-in slide-in-from-left-8 duration-700">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white mb-4 leading-tight drop-shadow-xl">
                                {ad.title}
                            </h2>
                            <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl mb-8 line-clamp-2 max-w-xl">
                                {ad.description}
                            </p>
                            <button
